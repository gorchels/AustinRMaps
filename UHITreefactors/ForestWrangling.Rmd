...
library(tmap) #Allows for builing interactive HTML tools 
library(spatstat) #Spatial statistics, not used here but included in case I change that 
library(maptools) #Allows for manipulating maps and other geospatial tools
...
library(stargazer) #For making tables of multiple linear regression, not used here but could create a table of the correlation at the end 
